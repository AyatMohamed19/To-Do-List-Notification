// getDay() that returns the day of the week, 1 to 7
// getYear() that is deprecated.
window.onload = () => {
    ...
    function displayData() {
      ...
      while (taskList.firstChild) { //to prevent Duplicated
      ...
      objectStore.openCursor().onsuccess = (event) => {
        ...
        deleteButton.style.backgroundColor="rgb(104, 149, 178)";
